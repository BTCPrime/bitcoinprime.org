...
(function(e) {
    e.fn.notifyMe = function() {
        ...
        // Alert messages
        var thvalid        = '<p class="notify-valid"><span><i class="fas fa-check"></i></span>Congrats! You are in list.<br>We will inform you as soon as we finish.</p>';
        var thproblem      = '<p class="notify-valid"><span><i class="fas fa-times"></i></span>Your e-mail address is incorrect.<br>Please check it and try again.</p>';
        var thoops         = '<p class="notify-valid"><span><i class="fas fa-times"></i></span>Looks like something went wrong.<br>Please try again later.</p>';
        var thfake         = '<p class="notify-valid"><span><i class="fas fa-times"></i></span>This email address looks fake or invalid.<br>Please enter a real email address.</p>';
        var thavailability = '<p class="notify-valid"><span><i class="fas fa-times"></i></span>Service is not available at the moment.<br>Please check your internet connection or try again later.</p>';
